...
Note:
    In MySQL, 'gold' is implemented as a separate database rather than a
    schema inside a shared database (as used in SQL Server).
===============================================================================
*/
...
ON
    pn.cat_id = pc.id
WHERE
    pn.prd_end_dt IS NULL; -- Filter out all historical data, keep only current products
